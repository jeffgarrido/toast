        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">
                    <b class="fa fa-lg fa-book"></b> Add Course
                </h1>
                <ol class="breadcrumb">
                    <li>
        ...
        <fieldset>
            ...
            <div class="col-lg-5">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-7">
                        <input class="form-control" id="Title" name="Title" placeholder="Course Title" type="text" required/>
                    </div>
                </div>
                <div class="form-group">
                    <label for="Title" class="col-lg-4 control-label">Units</label>
                    <div class="col-lg-7">
                        <input class="form-control" id="Units" name="Units" placeholder="Number of Units" type="number" required/>
                    </div>
                </div>
                <div class="form-group">
