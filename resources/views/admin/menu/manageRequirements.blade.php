                ...
                <div class="col-lg-12">
                    <h1 class="page-header">
                        ...
                        <div class="pull-right">
                            <button class="btn btn-lg btn-success"><i class="fa fa-plus"></i> Add Requirement</button>
                        </div>
                    </h1>
                    <ol class="breadcrumb">
                        <li>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="form-group">
                                                <label for="Type" class="col-lg-4 control-label">Type of Requirement</label>
                                                <div class="col-lg-7">
                                            ...
                                            <div class="col-md-12">
                                                @foreach($course->outcomes()->get() as $outcome)
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-7">
                                                            <select class="form-control outcomeList" multiple="multiple" id="course" name="{{$outcome->Outcome_Id}}[]">
